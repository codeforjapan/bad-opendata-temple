    ...
    <footer>
      ...
      <ContactContainer>
        <AddressContainer>
          <h2>寺務所</h2>
          <p>Code for Japan内</p>
          <p>まずは<a href="https://join.slack.com/t/cfj/shared_invite/zt-473qa2x1-Fc_Uo76uPPRm2j~JBWRx1w">こちら</a>からCode for Japanの公式Slackにご参加頂き、以下のチャンネルにご参加ください。</p>
          <span>#proj-bod供養寺</span>
        </AddressContainer>
        <TempleImg fixed={data.temple.childImageSharp.fixed} />
      </ContactContainer>
      <CopyContainer>
        <small>このサイトの内容物は クリエイティブ・コモンズ 表示 4.0 ライセンス の下に提供されています。 &copy; 2020 BADオープンデータ供養寺</small>
      </CopyContainer>
    </footer>
  )
}
