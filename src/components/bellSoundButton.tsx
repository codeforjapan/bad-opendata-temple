...
const Stick = styled.div`
  width: 43px;
  cursor: url('${(props: Props) => props.stick}') 10 30, auto;
  &:active {
    cursor: url('${(props: Props) => props.stickTaped}') 10 20, auto;
  }
`
...
const BellSoundButton = () => {
  ...
  return (
    <Stick stick={data.stick.publicURL} stickTaped={data.stickTaped.publicURL}>
