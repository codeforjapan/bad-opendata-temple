...
export type File = Node & {
  ...
  childrenInformationCsv?: Maybe<
    Array<Maybe<InformationCsv>>
  >;
...
export type FileFieldsEnum =
  ...
  | 'childrenInformationCsv___parent___parent___id'
  | 'childrenInformationCsv___parent___parent___children'
  | 'childrenInformationCsv___parent___children'
  | 'childrenInformationCsv___parent___children___id'
  | 'childrenInformationCsv___parent___children___children'
  | 'childrenInformationCsv___parent___internal___content'
  | 'childrenInformationCsv___parent___internal___contentDigest'
  | 'childrenInformationCsv___parent___internal___description'
  | 'childrenInformationCsv___parent___internal___fieldOwners'
  | 'childrenInformationCsv___parent___internal___ignoreType'
  | 'childrenInformationCsv___parent___internal___mediaType'
  | 'childrenInformationCsv___parent___internal___owner'
  | 'childrenInformationCsv___parent___internal___type'
  | 'childrenInformationCsv___children'
  | 'childrenInformationCsv___children___id'
  | 'childrenInformationCsv___children___parent___id'
  | 'childrenInformationCsv___children___parent___children'
  | 'childrenInformationCsv___children___children'
  | 'childrenInformationCsv___children___children___id'
  | 'childrenInformationCsv___children___children___children'
  | 'childrenInformationCsv___children___internal___content'
  | 'childrenInformationCsv___children___internal___contentDigest'
  | 'childrenInformationCsv___children___internal___description'
  | 'childrenInformationCsv___children___internal___fieldOwners'
  | 'childrenInformationCsv___children___internal___ignoreType'
  | 'childrenInformationCsv___children___internal___mediaType'
  | 'childrenInformationCsv___children___internal___owner'
  | 'childrenInformationCsv___children___internal___type'
  | 'childrenInformationCsv___internal___content'
  | 'childrenInformationCsv___internal___contentDigest'
  | 'childrenInformationCsv___internal___description'
  | 'childrenInformationCsv___internal___fieldOwners'
  | 'childrenInformationCsv___internal___ignoreType'
  | 'childrenInformationCsv___internal___mediaType'
  | 'childrenInformationCsv___internal___owner'
...
export type InformationCsvFilterListInput = {
  elemMatch?: Maybe<InformationCsvFilterInput>;
};
...
export type SitePluginPluginOptions = {
  plugins?: Maybe<
    Array<Maybe<SitePluginPluginOptionsPlugins>>
  >;
...
export type Unnamed_1_Query = {
  ...
  stick?: Maybe<Pick<File, 'publicURL'>>;
  stickTaped?: Maybe<Pick<File, 'publicURL'>>;
};
...
export type Unnamed_2_Query = {
  bgImg?: Maybe<Pick<File, 'publicURL'>>;
};
...
export type Unnamed_3_Query = {
  red?: Maybe<Pick<File, 'publicURL'>>;
  white?: Maybe<Pick<File, 'publicURL'>>;
};
...
export type Unnamed_5_Query = {
  ...
  github?: Maybe<Pick<File, 'publicURL'>>;
};
...
export type Unnamed_6_Query = {
  ...
  templedNight?: Maybe<Pick<File, 'publicURL'>>;
};
...
export type Unnamed_7_Query = {
  allInformationCsv: {
    nodes: Array<
      Pick<InformationCsv, 'date' | 'text' | 'url'>
    >;
  };
};
...
export type Unnamed_8_Query = {
  jushoku?: Maybe<Pick<File, 'publicURL'>>;
};
...
export type Unnamed_9_Query = {
  allHitokotoCsv: {
    nodes: Array<Pick<HitokotoCsv, 'word'>>;
  };
...
export type ListOfContentsQueryQueryVariables = Exact<{
  [key: string]: never;
}>;

export type ListOfContentsQueryQuery = {
  allMarkdownRemark: {
    edges: Array<{
